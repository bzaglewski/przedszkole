...
<div class="aiovg aiovg-widget-form aiovg-widget-form-search">
	...
	<div class="aiovg-widget-field aiovg-widget-field-has_keyword">
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 'has_keyword' ) ); ?>"><?php esc_html_e( 'Search By Video Title, Description', 'all-in-one-video-gallery' ); ?></label>
	</div>
	...
	<div class="aiovg-widget-field aiovg-widget-field-has_tag">
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 'has_tag' ) ); ?>"><?php esc_html_e( 'Search By Tags', 'all-in-one-video-gallery' ); ?></label>
	</div>
</div>