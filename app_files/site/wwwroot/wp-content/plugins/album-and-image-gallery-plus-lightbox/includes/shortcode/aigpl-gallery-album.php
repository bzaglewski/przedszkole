...
function aigpl_gallery_album( $atts, $content = null ) {
	...
	extract(shortcode_atts(array(
		...
		'id'					=> array(),
		'category' 				=> '',
		/*'total_photo'			=> '{total}'.' '.__('Zdjęć','album-and-image-gallery-plus-lightbox'), */
	...
	$album_description	= ($album_description == 'false')	? 1									: 0;
	...
	<?php
		wp_reset_postdata(); // Reset WP Query
			...
			echo "<div class='aigpl-breadcrumb-wrp'><a class='aigpl-breadcrumb' href='{$album_page}'>".__('Powrót do galerii', 'album-and-image-gallery-plus-lightbox')."</a> &raquo; ".get_the_title($post_ids)."</div>";
