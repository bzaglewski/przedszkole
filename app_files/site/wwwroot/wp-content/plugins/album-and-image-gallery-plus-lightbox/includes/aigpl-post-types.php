...
function aigpl_register_post_type() {
	...
	$aigpl_post_lbls = apply_filters( 'aigpl_post_labels', array(
								'name'                 	=> __('Galerie', 'album-and-image-gallery-plus-lightbox'),
								'singular_name'        	=> __('Galerie', 'album-and-image-gallery-plus-lightbox'),
								'add_new'              	=> __('Dodaj galerie', 'album-and-image-gallery-plus-lightbox'),
								'add_new_item'         	=> __('Dodaj nową galerie', 'album-and-image-gallery-plus-lightbox'),
								'edit_item'            	=> __('Edytuj galerie', 'album-and-image-gallery-plus-lightbox'),
								'new_item'             	=> __('Nowa galeria', 'album-and-image-gallery-plus-lightbox'),
								'view_item'            	=> __('Zobacz galerie', 'album-and-image-gallery-plus-lightbox'),
								'search_items'         	=> __('Znajdź galerie', 'album-and-image-gallery-plus-lightbox'),
								...
								'parent_item_colon'    	=> '',
								'featured_image'		=> __('Zdjęcie galerii', 'album-and-image-gallery-plus-lightbox'),
								'set_featured_image'	=> __('Wybierz zdjęcie galerii', 'album-and-image-gallery-plus-lightbox'),
								'remove_featured_image'	=> __('Usuń zdjęcie główne galerii', 'album-and-image-gallery-plus-lightbox'),
								'menu_name'           	=> __('Galerie', 'album-and-image-gallery-plus-lightbox')
							));
...
function aigpl_register_taxonomies() {
	...
	$aigpl_cat_lbls = apply_filters('aigpl_cat_labels', array(
		'name'              => __( 'Kategorie', 'album-and-image-gallery-plus-lightbox' ),
		'singular_name'     => __( 'Kategorie', 'album-and-image-gallery-plus-lightbox' ),
		...
		'menu_name'         => __( 'Kategorie', 'album-and-image-gallery-plus-lightbox' ),
	));
