...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public static function check_conditionals() {
		...
		if ( ( is_singular() || is_front_page() ) && ! is_home() ) {
			...
			// Sidebar ID.
			if ( isset( $postsidebar ) && ! empty( $postsidebar ) && 'defualt' !== $postsidebar ) {
			...
			// Sidebar ID.
			if ( isset( $archivesidebar ) && ! empty( $archivesidebar ) && 'defualt' !== $archivesidebar ) {
	...
	public function filter_body_classes( array $classes ) : array {
		...
		$classes[] = 'content-title-style-' . self::get_title_layout();
		$classes[] = 'content-width-' . self::get_layout();
		$classes[] = 'content-style-' . self::get_boxed();
		$classes[] = 'content-vertical-padding-' . self::get_vertical_padding();
		$classes[] = self::get_desk_transparent_class();
		$classes[] = self::get_mobile_transparent_class();
