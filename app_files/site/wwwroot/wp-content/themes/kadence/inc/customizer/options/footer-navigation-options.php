...
$settings = array(
	...
	'footer_navigation_color' => array(
		...
		'live_method'     => array(
			...
			array(
				'type'     => 'css',
				'selector' => '.footer-navigation .footer-menu-container > ul li a:hover',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'hover',
			),
			array(
				'type'     => 'css',
				'selector' => '.footer-navigation .footer-menu-container > ul li.current-menu-item > a, .footer-navigation .footer-menu-container > ul li.current_page_item > a',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'active',
			),
