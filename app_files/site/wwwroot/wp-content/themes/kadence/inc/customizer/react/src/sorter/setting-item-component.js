		...
		return (
			<div className="kadence-sorter-item" data-id={ this.props.item } key={ this.props.item }>
				<div className={ `kadence-sorter-item-panel-header ${ ( this.state.item.enabled ? 'panel-item-is-visible' : 'panel-item-is-hidden' ) }` }>
					...
					{ 'title' !== this.props.item && 'above_title' !== this.props.item && 'category' !== this.props.item && 'breadcrumb' !== this.props.item && 'description' !== this.props.item && 'readmore' !== this.props.item && 'rating' !== this.props.item && 'product_meta' !== this.props.item && 'share' !== this.props.item && (
