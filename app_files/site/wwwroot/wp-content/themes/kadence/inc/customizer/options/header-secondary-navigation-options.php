...
$settings = array(
	...
	'secondary_navigation_spacing' => array(
		...
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.secondary-navigation .secondary-menu-container > ul > li > a',
	...
	'secondary_navigation_color' => array(
		...
		'live_method'     => array(
			...
			array(
				'type'     => 'css',
				'selector' => '.secondary-navigation .secondary-menu-container > ul > li > a:hover',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'hover',
			),
			array(
				'type'     => 'css',
				'selector' => '.secondary-navigation .secondary-menu-container > ul > li.current-menu-item > a, .secondary-navigation .secondary-menu-container > ul > li.current_page_item > a',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'active',
			),
