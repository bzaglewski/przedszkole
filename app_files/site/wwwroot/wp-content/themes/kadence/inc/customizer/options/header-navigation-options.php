...
$settings = array(
	...
	'primary_navigation_spacing' => array(
		...
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.main-navigation .primary-menu-container > ul > li > a',
	...
	'primary_navigation_color' => array(
		...
		'live_method'     => array(
			...
			array(
				'type'     => 'css',
				'selector' => '.main-navigation .primary-menu-container > ul > li > a:hover',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'hover',
			),
			array(
				'type'     => 'css',
				'selector' => '.main-navigation .primary-menu-container > ul > li.current-menu-item > a, .main-navigation .primary-menu-container > ul > li.current_page_item > a',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'active',
			),
