...
$settings = array(
	...
	'footer_bottom_link_colors' => array(
		...
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '#colophon .site-bottom-footer-wrap .site-footer-row-container-inner a',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'color',
			),
			array(
				'type'     => 'css',
				'selector' => '#colophon .site-bottom-footer-wrap .site-footer-row-container-inner a:hover',
				'property' => 'color',
				'pattern'  => '$',
				'key'      => 'hover',
			),
	...
	// 	'default'      => kadence()->default( 'footer_bottom_top_border' ),
	// 	'context'      => array(
	// 		array(
	// 			'setting' => '__current_tab',
	// 			'value'   => 'design',
	...
	// 	'default'      => kadence()->default( 'footer_bottom_bottom_border' ),
	// 	'context'      => array(
	// 		array(
	// 			'setting' => '__current_tab',
	// 			'value'   => 'design',
